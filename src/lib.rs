...
static LOOKUP_TABLE: phf::Map<&'static str, &'static str> = phf_map! {
    "AD" => "Andorra",
...
pub fn mega_match(s: &str) -> &'static str {
    match s {
        "AD" => "Andorra",
        "AE" => "United Arab Emirates",
        "AF" => "Afghanistan",
...
pub fn phf(s: &str) -> &'static str {
    LOOKUP_TABLE.get(s).unwrap_or(&DEFAULT_STR)
}
